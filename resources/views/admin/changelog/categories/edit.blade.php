        ...
        @foreach($locales as $code => $name)
            <li class="nav-item">
                <a class="nav-link @if($code === $locale) active @endif"
                   href="{{ route('extended-translation.admin.changelog.categories.edit', [$category, $code]) }}">
                    {{ $name }}
    ...
    <div class="row g-4">
        <div class="col-lg-5">
            <div class="card shadow mb-4">
                <div class="card-header d-flex align-items-center justify-content-between">
                    <span>{{ trans('extended-translation::changelog.categories.source') }}</span>
                    <a href="{{ route('changelog.admin.categories.edit', $category) }}" class="btn btn-sm btn-outline-secondary">
        ...
        <div class="col-lg-7">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('extended-translation.admin.changelog.categories.update', [$category, $locale]) }}" method="POST">
                        @method('PUT')
                        @csrf
                        ...
                        @if($translation)
                            <a href="{{ route('extended-translation.admin.changelog.categories.destroy', [$category, $locale]) }}" class="btn btn-danger" data-confirm="delete">

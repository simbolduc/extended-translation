...
@section('content')
    <p class="mb-3">
        <a href="{{ route('extended-translation.admin.pages.index') }}" class="btn btn-outline-secondary">
        ...
        @foreach($locales as $code => $name)
            <li class="nav-item">
                <a class="nav-link @if($code === $locale) active @endif"
                   href="{{ route('extended-translation.admin.pages.edit', [$page, $code]) }}">
                    {{ $name }}
    ...
    <div class="row g-4">
        <div class="col-lg-5">
            <div class="card shadow mb-4">
                <div class="card-header d-flex align-items-center justify-content-between">
                    <span>{{ trans('extended-translation::admin.pages.source') }}</span>
                ...
                <div class="card-body">
                    ...
                    <p class="text-body-secondary">{{ $page->description }}</p>
        ...
        <div class="col-lg-7">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('extended-translation.admin.pages.update', [$page, $locale]) }}" method="POST">
                        @method('PUT')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('title') is-invalid @enderror" id="titleInput" name="title" value="{{ old('title', $translation->title ?? $page->title) }}" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('description') is-invalid @enderror" id="descriptionInput" name="description" value="{{ old('description', $translation->description ?? $page->description) }}" required>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control html-editor @error('content') is-invalid @enderror" id="textArea" name="content" rows="5">{{ old('content', $translation->content ?? $page->content) }}</textarea>
                        ...
                        @if($translation)
                            <a href="{{ route('extended-translation.admin.pages.destroy', [$page, $locale]) }}" class="btn btn-danger" data-confirm="delete">

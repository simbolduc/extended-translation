...
Azuriom plugin to translate news posts, pages, navbar items, FAQ questions, wiki pages, vote reward names, and changelog content from the admin panel, without changing Azuriom core. It also provides a public language dropdown that themes can include.

FAQ, Wiki, Vote, and Changelog translation are optional: install and enable the [FAQ](https://market.azuriom.com/resources/4), [Wiki](https://market.azuriom.com/resources/28), [Vote](https://market.azuriom.com/resources/2), or [Changelog](https://market.azuriom.com/resources/53) plugin to show those items in **Admin → Translations**. Wiki search still uses the original language; only displayed category names, page titles, and page content are translated. Vote translation covers reward names only. Changelog translation covers the page title, category names, and update names and content.
...
Plugin Azuriom pour traduire les articles, les pages, les éléments de la barre de navigation, les questions de la FAQ, les pages du wiki, les noms des récompenses de vote et le contenu du changelog depuis le panel administrateur, sans modifier le coeur d’Azuriom. Il fournit aussi un menu déroulant de langue que les thèmes peuvent inclure.

La traduction de la FAQ, du wiki, de Vote et du Changelog est facultative : installez et activez le plugin [FAQ](https://market.azuriom.com/resources/4), [Wiki](https://market.azuriom.com/resources/28), [Vote](https://market.azuriom.com/resources/2) ou [Changelog](https://market.azuriom.com/resources/53) pour afficher ces entrées dans **Admin → Traductions**. La recherche du wiki utilise toujours la langue originale ; seuls les noms de catégories, les titres et le contenu des pages affichés sont traduits. La traduction de Vote concerne uniquement les noms des récompenses. La traduction du Changelog concerne le titre de la page, les noms de catégories et les noms et contenus des mises à jour.
